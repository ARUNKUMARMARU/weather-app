...
//   <p><SunOutlined />Light mode </p> 
//   <p><MoonFilled />Dark mode </p>
//   </div>
// <div className='search'>
// <Search placeholder="Enter City Name"  enterButton 
// onSearch={(e)=>getWeather(e)}/>
    ...
    <div className={isLightMode ? 'light-mode' : 'dark-mode'}>
      <div className='pg'>
        ...
        <div className='theme'>
          ...
          <div className='search'>
            <Search placeholder="Enter City Name" enterButton onSearch={(e) => getWeather(e)} />
          </div> 
          <br />
          <div>
            <p className='city'>{cityName}</p>
